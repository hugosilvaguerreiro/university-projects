...
public class Tomato extends Ingredient {
    ...
    public Tomato(Color color, Point point){
        super(color, point);
        setBlockOrder();
    }
    public Tomato(Image image, Point point){
        super(image, point);
        setBlockOrder();
    }
    public Tomato(Point point) {
        super();
        try {
            this.image = Util.flipImageHorizontally(ImageIO.read(Resources.tomato));
            this.point = point;
