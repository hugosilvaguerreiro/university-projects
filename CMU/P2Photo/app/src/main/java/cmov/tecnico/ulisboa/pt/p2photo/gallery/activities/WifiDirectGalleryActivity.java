...
public class WifiDirectGalleryActivity extends GalleryBaseActivity {
    ...
    private static String TAG = "WifiDirectGalleryActivity";
            ...
            if(resultCode == Activity.RESULT_OK) {
                ...
                mBuilder.setPositiveButton("Share", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        onAddUsersToAlbum(share_user_id, albumId);
                    }
                });
                mBuilder.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Log.d("WifiDirect" , "Shared: CANCELLED");
                    }
                });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.provider = new DropboxProvider(WifiDirectGalleryActivity.this, new Observer() {
            @Override
        ...
        if(!hasToken()){
            Auth.startOAuth2Authentication(WifiDirectGalleryActivity.this, getString(R.string.app_key));
        }
    }
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent logout = new Intent(WifiDirectGalleryActivity.this, LogoutActivity.class);
