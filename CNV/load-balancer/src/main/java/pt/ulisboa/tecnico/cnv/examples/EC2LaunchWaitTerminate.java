package pt.ulisboa.tecnico.cnv.examples;/* 2016-18 Extended by Luis Veiga and Joao Garcia */
/*
...
public class EC2LaunchWaitTerminate {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            runInstancesRequest.withImageId("ami-0daaacb8b12e62dca")
                    .withInstanceType("t2.micro")
                    .withMinCount(1)
                    .withMaxCount(1)
                    .withKeyName("cnvInstancesKeyPair")
                    .withSecurityGroups("Cnv/HillClimb");
