...
namespace DIDA_SCRIPT_CLIENT.script_client
{
    ...
    class Tokenizer
    {
        ...
        public Tokenizer()
        {
            ...
            FieldRegex = "(" + StringField + "|" + ObjectField + "),{0,1}";
        ...
        private List<Token> ParseMultipleArgumentsCommandTokens(string commandName, List<string> tokens)
        {
            ...
            foreach(string token in tokens)
            {
                ...
                if (MatchObjectField.Success)
                {
                    ...
                    DummyClass dummy = new DummyClass("Dummy", classFields);
                    result.Add(new Token("object_field", new ObjectField(dummy)));
                    continue;
                }
